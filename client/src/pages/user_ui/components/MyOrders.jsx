...
const MyOrders = () => {
    ...
    return (
        <div className="bg-white shadow-xl w-full rounded-xl space-y-5 flex flex-col py-10">
            <div className="px-5">
                <h1 className="text-gray-600 text-xl">Orders</h1>
            </div>
            <div className='divide-y divide-solid px-5 h-56 overflow-y-scroll'>
                {
                    ...
                    products.map((product) => {
                        return (
                            <ProfileOrderItem product={product} />
                        )
                    })
                }
            </div>
